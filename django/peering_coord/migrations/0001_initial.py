# Generated by Django 3.2.7 on 2021-10-28 13:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.ManyToManyField(help_text="User accounts with access to this entity's ASes.", to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='PeeringClient',
